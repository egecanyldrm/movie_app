                ...
                <div className="collapse navbar-collapse " id="navbarCollapse">
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <a href="https://github.com/egecanyldrm" className='nav-link text-center my-2' >Github</a>
                        </li>
                        <li className="nav-item">
                            <a href="https://www.linkedin.com/in/egecan-yildirim/" className='nav-link text-center my-2'  >Linkedin</a>
                        </li>
                        <li className="nav-item">
                            <a href="https://www.egecanyildirim.com" className='nav-link text-center my-2' >Personal</a>
                        </li>
                    </ul>
                </div>
            </div>
